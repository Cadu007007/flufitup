...
<div class="items">
  ...
  <SidebarItem :class=" active == 'packages' ? 'active' : '' " 
  ...
  <SidebarItem :class=" active == 'profile' ? 'active' : '' " 
...
components:{
  ...
  props:['active','routetohome','routetopackages','routetoprofile','routetochat','routetooldorders','routetologout'],
