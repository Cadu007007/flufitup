    ...
    <form action="/dummy" method="post">
        ...
        <div class="form-container">
            <div class="input-row">
                ...
                <input type="text" class="input" name="name" placeholder="Promocode" :value="promocode[0].name">
            </div>
            <div class="input-row">
                <p class="title">Start Date :</p>
                <input type="text" :value="startDate ? startDate : promocode[0].start_date" class="input" name="start_date" placeholder="MM/DD/YYYY" @click="showCalendar(1)">
            </div>
            <div class="input-row">
                <p class="title">End Date :</p>
                <input type="text" :value="endDate ? endDate : promocode[0].end_date" class="input" name="end_date"  placeholder="MM/DD/YYYY" @click="showCalendar(2)">
            </div>
            <div class="input-row">
