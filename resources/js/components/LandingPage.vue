  ...
  <div class="landing-container" id="fullpage">
    ...
    <div class="why-choose-us-container section" id="whyChooseUs">
        ...
        <div class="why-us-features">
            <div class="feature-container" :class="activefeature == 1 ? 'active' : ''" @mouseenter="handleHover(1)" @mouseleave="handleHover(0)">
                <img src="/images/icons/diamond.svg" alt="" class="icon">
                <img src="/images/icons/diamond-white.svg" alt="" class="icon-active">
            ...
            <div class="feature-container" :class="activefeature == 2 ? 'active' : ''" @mouseenter="handleHover(2)" @mouseleave="handleHover(0)">
                <img src="/images/icons/bag-white.svg" alt="" class="icon-active">
            ...
            <div class="feature-container" :class="activefeature == 3 ? 'active' : ''" @mouseenter="handleHover(3)" @mouseleave="handleHover(0)">
                <img src="/images/icons/car.svg" alt="" class="icon">
                <img src="/images/icons/car-white.svg" alt="" class="icon-active">
            ...
            <div class="feature-container" :class="activefeature == 4 ? 'active' : ''" @mouseenter="handleHover(4)" @mouseleave="handleHover(0)">
                <img src="/images/icons/dollar.svg" alt="" class="icon">
                <img src="/images/icons/dollar-white.svg" alt="" class="icon-active">
            ...
            <div class="feature-container" :class="activefeature == 5 ? 'active' : ''" @mouseenter="handleHover(5)" @mouseleave="handleHover(0)">
                <img src="/images/icons/soap-bottle.svg" alt="" class="icon">
                <img src="/images/icons/soap-bottle-white.svg" alt="" class="icon-active">
            ...
            <div class="feature-container" :class="activefeature == 6 ? 'active' : ''" @mouseenter="handleHover(6)" @mouseleave="handleHover(0)">
                <img src="/images/icons/teriangle.svg" alt="" class="icon">
                <img src="/images/icons/teriangle-white.svg" alt="" class="icon-active">
            ...
            <div class="feature-container" :class="activefeature == 7 ? 'active' : ''" @mouseenter="handleHover(7)" @mouseleave="handleHover(0)">
                <img src="/images/icons/contactless.svg" alt="" class="icon">
                <img src="/images/icons/contactless-white.svg" alt="" class="icon-active">
        ...
        <div class="services-container">
            <div class="services-part">
                <div class="service-container">
                    <img src="/images/icons/basket.svg" alt="" class="icon">
                ...
                <div class="service-container">
                    <img src="/images/icons/basket-x.png" alt="" class="icon">
                    <div class="service-info">
                        <p class="title">
                            Dry Clean
                        </p>
            ...
            <div class="services-part">
                <div class="service-container">
                    <img src="/images/icons/washer.svg" alt="" class="icon">
                    <div class="service-info">
                        <p class="title">
    ...
    <div class="our-packages section reverse">
        <div class="title-container">
    ...
    <div class="contact-us section" id="contactUs">
        ...
        <div class="contact-form">
            <div class="left">
                <img src="/images/contact-us.svg" alt="" class="form-image">
            </div>
            <div class="right">
    ...
    <div class="get-in-touch">
        ...
        <div class="info">
            <div class="address info-section">
                <img src="/images/icons/location-white.svg" alt="" class="icon">
                <p class="text">Address</p>
            </div>

            <div class="double-info">
                <div class="phone info-section">
                    <img src="/images/icons/phone-white.svg" alt="" class="icon">
                    <p class="text">Phone Number</p>
                </div>
                <div class="email info-section">
                    <img src="/images/icons/email-white.svg" alt="" class="icon">
